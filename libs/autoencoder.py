    ...
    def __init__(self, cls=False, cls_num=32, reduce=False):
        ...
        if not cls:
            ...
            self.conv11 = nn.Sequential(
                nn.Conv2d(64, cls_num, 3, 1, 0), nn.LogSoftmax()
            )
...
def encoder_res18(pretrained=True, uselayer=3):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            torch.load("ae_models/resnet18-5c106cde.pth"), strict=False
        )
    return model
...
def encoder_res50(pretrained=True, uselayer=3):
    ...
    if pretrained:
        ...
        model.load_state_dict(
            torch.load("ae_models/resnet50-19c8e357.pth"), strict=False
        )
    return model
